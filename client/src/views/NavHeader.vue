<template>
    ...
    -->
    <header>
        <div class="header-center comWidth clearfix">
            <div class="header-l fl">
                <h1 class="logo fl">
                    <a href="javascript:;">
                        <img src="./../../static/images/logo.png" alt="凯游商城" title="凯游商城" />
                    </a>
                </h1>
            </div>
            <div class="header-c fl">
                <nav class="clearfix">
                    <a class="active" href="https://www.taobao.com/" target="_blank">淘宝</a>
            ...
            <div class="header-r fr clearfix">
                <!-- 购车车弹框组件 start -->
                <shopping-cart-box class="fl"></shopping-cart-box>
                <!-- 购车车弹框组件 end -->

                <!-- 注册和登录组件 start -->
                <reg-login class="fl"></reg-login>
                <!-- 注册和登录组件 end -->
            </div>
        </div>
    </header>
